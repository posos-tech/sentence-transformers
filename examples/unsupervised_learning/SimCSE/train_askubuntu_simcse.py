...
from BertBase.SentenceTransfo.wandb_callback import CustomStepCallback
...
askubuntu_folder = '/data0/research_ir/data/others/askubuntu'
output_path = '/data0/research_ir/data/others/askubuntu/askubuntu-simcse-{}-{}-{}'.format(
...
model = SentenceTransformer(
    modules=[word_embedding_model, pooling_model], device="cuda:1")
...
dev_evaluator = evaluation.RerankingEvaluator(
    dev_dataset, name='AskUbuntu dev')
test_evaluator = evaluation.RerankingEvaluator(
    test_dataset, name='AskUbuntu test')
...
step_callback = CustomStepCallback(
    Args(), "askubuntu", output_path, log_every_step=20)
